...
class OrganisationNode:
    """
    A tree node for rendering orgs in our hierarchy view
    """
    ...
    def __init__(self,sl, s, root_url):
        ...
        self.slug = sl
        self.children = []
        self.root_url = root_url or 'organisation'
    ...
    def linkify(self):
        # Should use
        # h.url_for(controller='ckanext.dgu_orgs.controllers.organisation:OrganisationController', action='read', id=self.slug)
