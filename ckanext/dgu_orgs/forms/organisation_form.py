...
from ckanext.dgu_orgs.plugins_toolkit import c, request, render, ValidationError, NotAuthorized, _, check_access
...
from ckanext.dgu_orgs.forms.validators import (validate_organisation_category,
                                          categories,
...
class OrganisationForm(SingletonPlugin):
    """
    This plugin implements an IGroupForm for form associated with an
    organisation group. ``IConfigurer`` is used to add the local template
    ...
    def history_template(self):
        return 'organisation/history.html'
    ...
    def form_to_db_schema(self, group_type=None):
        ...
        schema = {
            ...
            'category': [validate_organisation_category, convert_to_extras],
    ...
    def setup_template_variables(self, context, data_dict):
        pass # Moved to Organisation/OrganizationControl
