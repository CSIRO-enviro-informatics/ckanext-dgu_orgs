...
(function ($) {
  $(document).ready(function () {
    CKAN.Dgu.setupOrganisationUserAutocomplete($('input.autocomplete-organisation-user'));
...
CKAN.Dgu = function ($, my) {
  ...
  my.setupOrganisationUserAutocomplete = function (elements) {
    elements.autocomplete({
      ...
      select: function select(event, ui) {
        ...
        added_users.after('<input type="hidden" name="' + old_name + '" value="' + ui.item.value + '">' + '<input type="hidden" name="' + old_name.replace('__name', '__capacity') + '" value="' + capacity + '">' + '<dd>' + ui.item.label + '</dd>');
  ...
  my.setupPackageAutocomplete = function (elements) {
    elements.autocomplete({
      ...
      select: function select(event, ui) {
        ...
        added_users.after('<input type="hidden" name="' + old_name + '" value="' + ui.item.value + '">' + '<dd>' + ui.item.label + '</dd>');
      }
    });
  };
  return my;
